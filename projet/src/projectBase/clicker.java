...
public class clicker {
	 ...
	 static JLabel argentLabel = new JLabel(); // pas encore impl�menter (d�g�ts par seconde en int. graph.
	...
	public static void upgrade() { // commande pour am�liorer les d�g�ts
